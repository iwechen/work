...
author = "liriqing"
web_title = u"四川省住房和城乡建设厅信息中心"
data_source = 'http://www.scjst.gov.cn'

start_urls = [
    #招标公告
    "http://www.scjst.gov.cn/projectbidding/68/1.html",
    "http://www.scjst.gov.cn/projectbidding/67/1.html",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='info_text_title']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "_next_page": {'pattern': u"//a[contains(text(),'下一页') and @href]", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
}

# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='infoContent_info']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "_issue_time": {'pattern': "/html//div[@class='detailmessage']", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
