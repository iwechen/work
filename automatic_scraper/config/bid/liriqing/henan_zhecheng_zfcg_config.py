...
author = "liriqing"
web_title = u"柘城县人民政府"
data_source = 'http://www.zhecheng.gov.cn'

start_urls = [
    # 招标公告

     #政府采购
    "http://www.zhecheng.gov.cn/xxgk/zfcg/",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='nylb']//li",'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//table[@width='98%' and @align='center']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
