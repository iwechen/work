...
author = "liriqing"
web_title = u"北京经济技术开发区"
data_source = 'http://www.bda.gov.cn'

start_urls = [

    # 政府采购
    "http://www.bda.gov.cn/cms/zbgg/index.htm",
    #中标
    "http://www.bda.gov.cn/cms/zbgs/index.htm",
...
index_pattern = {
    ...
    "_issue_time": {'pattern': "//div[@class='f-right']", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
}

# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@id='contents']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
