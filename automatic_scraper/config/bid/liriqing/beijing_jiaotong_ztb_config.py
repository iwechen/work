...
start_urls = [
     ...
     #政府采购
    "http://www.bjjtw.gov.cn/xxgk/ztbxx/",
...
index_pattern = {
    ...
    "_issue_time": {'pattern': "//dt", 'type': 'xpath', 'target': 'text','custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='TRS_Editor' or @align='left']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
