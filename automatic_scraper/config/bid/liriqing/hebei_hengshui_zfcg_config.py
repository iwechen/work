...
author = "liriqing"
web_title = u"衡水市人民政府"
data_source = 'http://www.hszwzx.gov.cn'

start_urls = [

     #政府采购"
    "http://www.hszwzx.gov.cn/ggzy/ZFCG/index.shtml",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//table[@style='margin:10px auto' and @width='98%']//tr",'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//td[@class='neirong']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
