...
author = "liriqing"
web_title = u"北京国信中招"
data_source = 'http://wang147258369.jixiexinxi5.com'

start_urls = [
    #招标公告
    "http://wang147258369.jixiexinxi5.com/news/",
    "http://wang147258369.jixiexinxi5.com/info/",
...
index_pattern = {
    ...
    "_page_data": {'pattern': "/html//div[@class='pages']/label/span", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
}
...
def process_list_item(list_element, item):
    ...
    # 停止翻页
    if item['_current_page'] == page_count:
