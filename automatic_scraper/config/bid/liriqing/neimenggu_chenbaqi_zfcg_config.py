...
author = "liriqing"
web_title = u"陈巴尔虎旗政府"
data_source = 'http://www.cbrhq.gov.cn'

start_urls = [
    #招标公告
    "http://www.cbrhq.gov.cn/Category_31/Index.aspx",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//ul[@class='newsList']/li[not(@class='split')]", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='conTxt']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
def init(item):
    ...
    del item['web_title']
    item['region']=u'内蒙古自治区-呼伦贝尔市-陈巴尔虎旗'
