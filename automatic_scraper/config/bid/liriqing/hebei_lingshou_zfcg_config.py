...
author = "liriqing"
web_title = u"灵寿县人民政府"
data_source = 'http://www.lingshou.gov.cn'

start_urls = [

     #政府采购
    "http://www.lingshou.gov.cn/zwxxgk/zdsxgk/zhaotb/",
    "http://www.lingshou.gov.cn/zwxxgk/zdsxgk/zhengfucaigou/",
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='con']/ul/li[not (@class='line1') and position()<last()]",'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='main']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
