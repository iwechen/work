...
author = "liriqing"
web_title = u"中国-涂料"
data_source = 'http://www.coatingol.com'

start_urls = [
    #招标公告
    "http://www.coatingol.com/terminal/",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//table[@align='right']//tr", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//td[@class='ns_view_tb_content']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
