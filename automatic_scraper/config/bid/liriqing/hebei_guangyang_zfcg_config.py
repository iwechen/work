...
author = "liriqing"
web_title = u"廊坊市广阳区人民政府"
data_source = 'http://www.lfgy.gov.cn'

start_urls = [
    # 招标公告

     #政府采购
    "http://www.lfgy.gov.cn/html/zwgk/zfcg/",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='rightnlist']//li",'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='nr']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
