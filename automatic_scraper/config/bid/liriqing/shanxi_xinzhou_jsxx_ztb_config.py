...
author = "liriqing"
web_title = u"忻州建设信息网"
data_source = 'http://www.xinzhounet.cn'

start_urls = [
    # 招标公告

     #政府采购
    "http://www.xinzhounet.cn/Browse/NewsList.aspx?ID=54",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//table[@align='center' and @width='100%']//tr[position()<last()]",'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//td[@style='font-size: 14px; line-height: 25px; padding: 15px 0 5px 0;']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
