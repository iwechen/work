...
start_urls = [
    #招标公告
    "http://www.lszw.gov.cn/plus/list.php?tid=30",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//ul[@class='artlist']/li[not(@class='lastLi')]", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='c_content']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
