...
author = "liriqing"
web_title = u"中国林业网"
data_source = 'http://www.forestry.gov.cn'

start_urls = [
    #招标公告
    "http://www.forestry.gov.cn/SiteAction.do?dispatch=index&colid=2971&siteName=sdzg",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='con cl']/li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@id='zoom' or @id='zoomit']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
