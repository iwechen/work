...
author = "liriqing"
web_title = u"测绘网"
data_source = 'http://www.cehui8.com'

start_urls = [

     #政府采购
    "http://www.cehui8.com/zhaobiao/gongcheng/index.html",
    "http://www.cehui8.com/zhaobiao/shebei/",
    "http://www.cehui8.com/zhaobiao/qita/",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//ul[@class='mod-list']/li",'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@id='endText']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
