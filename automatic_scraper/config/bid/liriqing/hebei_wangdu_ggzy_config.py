...
author = "liriqing"
web_title = u"望都县人民政府"
data_source = 'http://www.wdx.gov.cn'

start_urls = [
    # 招标公告

     #政府采购
    "http://www.wdx.gov.cn/ejzwgk-392-more.html",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//table[@class='ej_list']//tr",'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "_next_page": {'pattern': u"//a[text()='下一页' and @onclick]", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "_issue_time": {'pattern': "//td[@width='90']", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
    "title": {'pattern': "//a", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
}

# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//table[@class='con_wznr']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
