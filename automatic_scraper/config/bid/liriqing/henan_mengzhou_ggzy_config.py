...
author = "liriqing"
web_title = u"孟州市人民政府"
data_source = 'http://www.mengzhou.gov.cn'

start_urls = [
    # 招标公告

     #政府采购
    "http://www.mengzhou.gov.cn/zwgk/ShowClass.asp?ClassID=6",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//ul[@class='is-listnews']/li",'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
