...
author = "liriqing"
web_title = u"天津供水"
data_source = 'http://www.jinghaiwater.com'

start_urls = [

     #政府采购
    "http://www.jinghaiwater.com/chanpin/",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='list03c']//li",'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='inf01']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
