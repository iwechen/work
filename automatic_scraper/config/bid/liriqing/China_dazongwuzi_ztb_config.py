...
author = "liriqing"
web_title = u"中国大宗物资"
data_source = 'http://www.zgdzwz.com'

start_urls = [

     #政府采购
    "http://www.zgdzwz.com/index.php?view=list2&type=17",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='newsList lh26']/ul/li",'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
