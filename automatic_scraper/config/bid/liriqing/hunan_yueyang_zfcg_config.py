...
author = "liriqing"
web_title = u"岳阳市政府采购"
data_source = 'http://www.yueyang.gov.cn'

start_urls = [
    # 招标公告

     #政府采购
    "http://www.yueyang.gov.cn/zwgk/25374/25376/25400/25421/default.htm",
    #建设工程
    "http://www.yueyang.gov.cn/zwgk/25374/25376/25400/25420/default.htm",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='bd']//li",'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    if re.search(u'招标|监理|采购|建设工程', item['title']):
        item['bid_type'] = 1
    elif re.search(u'中标|结果', item['title']):
        item['bid_type'] = 0
    elif re.search(u'中标候选', item['title']):
        item['bid_type'] = 4
    elif re.search(u'更改|澄清', item['title']):
        item['bid_type'] = 2
        # 停止翻页
