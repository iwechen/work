...
author = "liriqing"
web_title = u"阿拉善盟国家税务局"
data_source = 'http://als.nm-n-tax.gov.cn'

start_urls = [
    #招标公告
    "http://als.nm-n-tax.gov.cn/amgsj/xxgk/zfcg/list_1.shtml",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='con_1']//li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@id='newsbody']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
