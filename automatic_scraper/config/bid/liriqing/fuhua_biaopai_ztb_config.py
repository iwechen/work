...
author = "liriqing"
web_title = u"福华标牌制作有限公司"
data_source = 'http://www.cnfh168.cn'

start_urls = [
    #招标公告
    "http://www.cnfh168.cn/list/?135_1.html",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//ul[@class='postlist']/li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@id='contenttext']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
