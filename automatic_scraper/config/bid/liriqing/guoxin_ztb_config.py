...
author = "liriqing"
web_title = u"国信中招招标"
data_source = 'http://pengcheng.jixiexinxi5.com'

start_urls = [
    #招标公告
    "http://pengcheng.jixiexinxi5.com/news/",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//table[@cellpadding='2']//tr", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "_next_page": {'pattern': u"//a[contains(text(),'下一页') and @href]", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "title": {'pattern': "//a", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
    "_page_count": {'pattern': "/html//label/span", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    # 停止翻页
    if item['_current_page'] == int(item['_page_count']):
