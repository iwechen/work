...
author = "liriqing"
web_title = u"新疆建设工程信息网"
data_source = 'http://ztb.xjjs.gov.cn'
...
index_pattern = {
    ...
    "_next_page": {'pattern': "//td[@style='width:60%;']/a/img[@src='/xjweb/images/page/nextn.gif']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
