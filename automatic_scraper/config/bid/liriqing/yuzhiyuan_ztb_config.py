...
author = "liriqing"
web_title = u"宇之源太阳能"
data_source = 'http://www.solartech-sr.com'

start_urls = [

     #政府采购
    "http://www.solartech-sr.com/news.html?newsTypeID=8905&newsType=%E6%8B%9B%E6%A0%87%E4%BF%A1%E6%81%AF",
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='dnews_content']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    item['bid_type'] = 1
    if re.search(ur'中标公告',item['title']):
        item['bid_type'] = 0
