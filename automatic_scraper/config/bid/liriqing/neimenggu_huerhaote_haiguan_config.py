...
author = "liriqing"
web_title = u"呼和浩特海关"
data_source = 'http://huhehaote1.customs.gov.cn'

start_urls = [
    #招标公告
    "http://huhehaote1.customs.gov.cn/tabid/41309/Default.aspx",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@style='BORDER-BOTTOM: #e0e1e2 1px dashed; WIDTH: 100%; HEIGHT: 22px; PADDING-TOP: 3px']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
