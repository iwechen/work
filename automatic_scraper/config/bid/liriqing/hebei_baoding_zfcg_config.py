...
author = "liriqing"
web_title = u"河北省政府采购网"
data_source = 'http://www.hebei.gov.cn'

start_urls = [
    #招标公告
    "http://info.hebei.gov.cn/eportal/ui?pageId=6191352",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//table[@class='tab3']//tr", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "_next_page": {'pattern': u"//a[contains(text(),'下一页') and @onclick]", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "title": {'pattern': "//a", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
    "_issue_time": {'pattern': "//td[@width='110']", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
}

# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='portlet']/div[2]/div[3]", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
