...
author = "liriqing"
web_title = u"吉林省运政信息网"
data_source = 'http://www.jlsyz-gov.cn'

start_urls = [
    #招标公告
    "http://www.jlsyz-gov.cn/xw.asp?id=5",
    "http://www.jlsyz-gov.cn/xw.asp?id=6",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//table[@style='margin-top:5px']//tr", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='Custom_UnionStyle']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
