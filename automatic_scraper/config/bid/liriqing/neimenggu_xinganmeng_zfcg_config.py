...
author = "liriqing"
web_title = u"兴安盟政府采购网"
data_source = 'http://www.xamgp.cn'

start_urls = [

    #招标
    "http://www.xamgp.cn/gp/zbxx/e60c76f6-1.html",
    #中标
    "http://www.xamgp.cn/gp/zbxx56/053888b2-1.html",
...
def process_list_item(list_element, item):
    ...
    if 'zbxx56'in item['_current_start_url'] :
        item['bid_type']= 0
    else:
        item['bid_type'] = 1
