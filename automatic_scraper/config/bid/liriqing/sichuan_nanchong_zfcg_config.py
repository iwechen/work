...
author = "liriqing"
web_title = u"嘉陵区人民政府"
data_source = 'http://www.jialing.gov.cn'

start_urls = [
    # 招标公告

     #政府采购
    "http://www.jialing.gov.cn/a/zfcg/",
    "http://www.jialing.gov.cn/a/zbtb/",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//ul[@id='list_ul']/li[not(@style)]",'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='right_content_body']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
