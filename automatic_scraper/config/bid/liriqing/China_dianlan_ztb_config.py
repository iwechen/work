...
author = "liriqing"
web_title = u"芮城县人民政府"
data_source = 'http://www.rcx.gov.cn'

start_urls = [
    # 招标公告

     #政府采购
    "http://www.rcx.gov.cn/zfcg/index.htm",
    "http://www.rcx.gov.cn/gczb/index.htm",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//table[@class='table2' and @width='768']/tbody/tr/td/table//tr[position()>1 and position()<last()-1]",'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//tr[@class='fjyw_bgray']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    """
    item['url']=re.search(r'href=\"(.*?)\"',list_element,re.S).group(1)
