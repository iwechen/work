...
author = "liriqing"
web_title = u"数据中心招标"
data_source = 'http://dc.idcquan.com'

start_urls = [
    #招标公告
    "http://dc.idcquan.com/xmzb/",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//a[@class='d1']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='clear deatil article-content fontSizeSmall BSHARE_POP']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "_issue_time": {'pattern': "/html//div[@class='date']", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
