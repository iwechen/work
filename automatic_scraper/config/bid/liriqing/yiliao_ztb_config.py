...
author = "liriqing"
web_title = u"59医疗器械网"
data_source = 'http://www.59med.com'

start_urls = [
    # 招标公告

     #政府采购
    "http://www.59med.com/news/list-26.html",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='tab-content-left news_center']//li",'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    page_count=re.search(ur'/(\d+)页',item['_page_count'],re.S).group(1)
