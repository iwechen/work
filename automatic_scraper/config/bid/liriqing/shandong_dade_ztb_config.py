...
author = "liriqing"
web_title = u"山东大德永和工程咨询有限公司"
data_source = 'http://ddyh.fht360.com'

start_urls = [

     #政府采购
    "http://ddyh.fht360.com/info/255649/",
    "http://ddyh.fht360.com/info/255650/",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='download']/ul/li",'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    if '255649' in item['_current_start_url']:
        item['bid_type'] = 1
    elif '255650' in item['_current_start_url']:
        item['bid_type'] = 0
