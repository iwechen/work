...
author = "liriqing"
web_title = u"荆门市公共资源"
data_source = 'http://www.jmztb.net'

start_urls = [
    #招标公告

    "http://www.jmztb.net/Front/xxfb/003002/003002002/003002002001/",
    "http://www.jmztb.net/Front/xxfb/003002/003002001/003002001001/",
    #更正
    "http://www.jmztb.net/Front/xxfb/003002/003002002/003002002004/",
    "http://www.jmztb.net/Front/xxfb/003002/003002001/003002001004/",
...
def process_list_item(list_element, item):
    ...
    if '003002002001' in item['_current_start_url'] or '003002001001' in item['_current_start_url'] :
        item['bid_type'] = 1
    elif '003002002004' in item['_current_start_url'] or '003002001004' in item['_current_start_url']:
        item['bid_type'] = 2
