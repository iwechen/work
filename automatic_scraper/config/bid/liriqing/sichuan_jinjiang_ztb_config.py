...
author = "liriqing"
web_title = u"成都市锦江区人民政府"
data_source = 'http://www.cdjinjiang.gov.cn'

start_urls = [
    # 招标公告

     #政府采购
    "http://www.cdjinjiang.gov.cn/index.php?cid=56",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='cont_list']//li",'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@id='txt']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
