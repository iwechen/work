...
author = "liriqing"
web_title = u"铁路工程建设网"
data_source = 'http://www.rebcenter.com'

start_urls = [

    # 政府采购
    "http://www.rebcenter.com/bidInfo/list.action",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='center-text-list']/ul/li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='article']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
