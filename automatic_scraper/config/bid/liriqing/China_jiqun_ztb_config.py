...
author = "liriqing"
web_title = u"中国集群通信网"
data_source = 'http://www.pttcn.net'

start_urls = [

    # 政府采购
    "http://www.pttcn.net/plus/list.php?tid=80",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='block']/h2", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='post_content']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "_issue_time": {'pattern': "/html//span[@class='pt_info pre1']", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
