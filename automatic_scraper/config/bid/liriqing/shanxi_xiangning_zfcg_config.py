...
author = "liriqing"
web_title = u"乡宁县人民政府"
data_source = 'http://www.xiangning.gov.cn'

start_urls = [

     #政府采购
    "http://www.xiangning.gov.cn/channels/180.html",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='con']/ul",'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "_next_page": {'pattern': u"//a[contains(text(),'下一页') and @href]", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "title": {'pattern': "//a", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
    "_issue_time": {'pattern': "//li[@class='time']", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
}
