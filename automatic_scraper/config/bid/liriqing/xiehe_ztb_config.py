...
author = "liriqing"
web_title = u"协合新能源集团有限公司"
data_source = 'http://www.chinawindpower.com.hk'

start_urls = [
    #招标公告
    "http://www.chinawindpower.com.hk/zh/bid/",
    "http://www.chinawindpower.com.hk/zh/bid/party/",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='news-wrap']//li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    if 'party' in item['_current_start_url']:
        item['bid_type'] = 0
    else:
        item['bid_type'] = 0
