...
author = "liriqing"
web_title = u"远大咨询"
data_source = 'http://www.ydsws.com'

start_urls = [
    #招标公告
    "http://www.ydsws.com/html/zbzx/zbgg/",
    "http://www.ydsws.com/html/zbzx/jggs/",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//td[@class='news_list']/table[2]//li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//td[@id='text']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    if 'zbgg' in item['_current_start_url']:
        item['bid_type'] = 1
    elif 'jggs' in item['_current_start_url']:
        item['bid_type'] = 0
