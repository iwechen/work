...
author = "lidongjie"
web_title = u"咸阳市公共资源交易平台中心"
data_source = 'http://www.xyzhb.com'

start_urls = [
    "http://www.xyzhb.com/zbgg/index.jhtml",  #招标公告
    "http://www.xyzhb.com/zhbgg/index.jhtml",  #中标公告
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='isoc_dynamic-right fr']//li", 'type': 'xpath', 'target': 'html','custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    """
    if item['url']=='http://www.xyzhb.com/zbgg/2575.jhtml':
        del item['url']
        return
