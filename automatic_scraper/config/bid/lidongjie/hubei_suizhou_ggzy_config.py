...
author = "lidongjie"
web_title = u"随州市公共资源交易网"
data_source = 'http://www.szztb.com.cn'

start_urls = [
    "http://www.szztb.com.cn/Category/More?id=643&typeId=0",
    "http://www.szztb.com.cn/Category/More?id=644&typeId=0",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@id='listCon']//li", 'type': 'xpath', 'target': 'html','custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='newsBox']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
