...
author = "lidongjie"
web_title = u"广州市鸿兴禽业有限公司"
data_source = 'http://www.hongxingqinye.com'

start_urls = [
    "http://www.hongxingqinye.com/html/news/",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//dl[@class='news_dl']",'type':'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='pro_main']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "title": {'pattern': "//div[@class='pro_main']//h3", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
    "issue_time":{'pattern': "//div[@class='info_con_tit']", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
