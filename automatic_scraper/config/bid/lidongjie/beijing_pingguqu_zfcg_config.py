...
author = "lidongjie"
web_title = u"平谷区人民政府"
data_source = 'http://www.bjpg.gov.cn'

start_urls = [
    "http://www.bjpg.gov.cn/publish/portal0/tab311/",
    "http://www.bjpg.gov.cn/publish/portal0/tab312/",
    "http://www.bjpg.gov.cn/publish/portal0/tab313/",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//table[@class='news2']//tr",'type':'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//table[@ class='Normal']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
