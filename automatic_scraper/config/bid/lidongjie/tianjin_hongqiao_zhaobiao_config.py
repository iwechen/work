...
author = "lidongjie"
web_title = u"天津红桥政务网"
data_source = 'http://www.tjhqqzf.gov.cn'

start_urls = [
    "http://www.tjhqqzf.gov.cn/zwgk/zdly/ztb/", #1
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//td[@height='350']//tbody/tr",'type':'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//td[@class='hanggao26']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "title": {'pattern': "//td[@class='zi18 jiacu']", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
...
def process_detail_item(item):
    ...
    """
    if 'ztb' in item['_current_start_url']:
        item['bid_type'] = 1
    else:
        item['bid_type'] = '-1'
