...
author = "lidongjie"
web_title = u"宜春政府采购"
data_source = 'http://www.ycf.gov.cn'

start_urls = [
    #zbgg
    "http://www.ycf.gov.cn/zwgk/zfcg_11407/zbgg/",


    #zbgs
    "http://www.ycf.gov.cn/zwgk/zfcg_11407/zbgg_10945/",
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//tr[@align='left']", 'type': 'xpath', 'target': 'html','custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//td[@id='_NewsContent']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
    "title": {'pattern': "//td[@height='70']", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    """
    if 't20171013_520' in item ['url']or 't20171012_520867'in item[
        'url']or 't20171012_520806'in item ['url'] or't20171013_520927' in item[
        'url'] or't20171013_521007' in item[ 'url']or 't20171013_520979'in item['url']:
        del item['url']
        return
    logger.debug(item['url'])
    # 停止翻页
    # if item ['url']=='http://www.ycf.gov.cn/zwgk/zfcg_11407/zbgg/201710/t20171013_521007.htm':
    #     del item['url']
