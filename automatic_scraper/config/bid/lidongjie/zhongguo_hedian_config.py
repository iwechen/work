...
author = "lidongjie"
web_title = u"中国核电工程有限公司"
data_source = 'http://zb.cnpe.cc'

start_urls = [
    "http://zb.cnpe.cc/news/list.aspx?type=2", #1
    "http://zb.cnpe.cc/news/list.aspx?type=15", #6
    "http://zb.cnpe.cc/news/list.aspx?type=3", #0
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//td[@valign='top']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
def process_detail_item(item):
    ...
    if '2' in item['_current_start_url']:
        item['bid_type'] = 1
            ...
            item['bid_type'] = 0
    elif '15' in item['_current_start_url']:
            item['bid_type'] = 6
    else:
        item['bid_type'] = '-1'
