...
author = "lidongjie"
web_title = u"哈尔滨经济技术开发区"
data_source = 'http://www.kfq.gov.cn'

start_urls = [
    "http://www.kfq.gov.cn/zwxx/ztbgg/index.htm",
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='zwxx_list']//ul//li",'type':'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='end_font']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "title": {'pattern': "////h1[@class='end_h1']", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
