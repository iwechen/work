...
author = "lidongjie"
web_title = u"齐齐哈尔公共资源交易网"
data_source = 'http://www.qqhrggzy.cn'

start_urls = [
     "http://www.qqhrggzy.cn/page/index.jspx?type=notice&code=biddingNotice_dyproject",  # 招标公告
     "http://www.qqhrggzy.cn/page/index.jspx?type=notice&code=change_dyproject",  # 变更公告
     "http://www.qqhrggzy.cn/page/index.jspx?type=notice&code=getBidding_dyproject",  # 中标公示
     "http://www.qqhrggzy.cn/page/index.jspx?type=notice&code=biddingNotice_purchase",  # 采购公告
     "http://www.qqhrggzy.cn/page/index.jspx?type=notice&code=change_purchase",  # 变更公告
    #"http://www.qqhrggzy.cn/page/index.jspx?type=notice&code=getBidding_purchase"  # 中标公示
]
