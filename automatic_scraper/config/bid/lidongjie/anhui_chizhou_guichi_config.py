...
author = "lidongjie"
web_title = u"贵池区政府采购网"
data_source = 'http://www.gczfcg.gov.cn'

start_urls = [

    "http://www.gczfcg.gov.cn/guichifront/qjcg/001002/",#1
    "http://www.gczfcg.gov.cn/guichifront/qjcg/001003/",#0
    "http://www.gczfcg.gov.cn/GuiChifront/qjcg/001005/",#2
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//tr[@class='trfont']",'type':'xpath', 'target': 'html', 'custom_func_name': ''},
...
detail_pattern = {
    ...
    "title": {'pattern': "//div[@class='reportTitle']//h1", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
