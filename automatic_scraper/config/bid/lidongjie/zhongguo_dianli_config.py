...
author = "lidongjie"
web_title = u"电力招标网"
data_source = 'http://www.zgdlzb.cn'

start_urls = [

    "http://www.zgdlzb.cn/quote/chd/",
...
detail_pattern = {
    ...
    "title": {'pattern': "//h1[@id='title']", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
...
def process_detail_item(item):
    ...
    """
    if'dianlishebei' in item['_current_start_url']:
        item['bid_type'] = 1
    else:
        item['bid_type'] = '-1'
