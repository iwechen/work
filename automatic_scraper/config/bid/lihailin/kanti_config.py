...
author = "lihailin"
web_title = u"中招康泰项目管理有限公司"
data_source = 'http://www.kanti.cn'

start_urls = [
   "http://www.kanti.cn/article/listitem?categoryid=2",
    "http://www.kanti.cn/article/listitem?categoryid=4"
]
