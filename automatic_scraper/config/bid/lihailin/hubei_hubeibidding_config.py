...
author = "lihailin"
web_title = u"湖北成套招标股份有限公司"
data_source = 'http://www.hubeibidding.com'

start_urls = [
    #招标中标答疑
    "http://www.hubeibidding.com/plus/list.php?tid=4",
    "http://www.hubeibidding.com/plus/list.php?tid=5",
    "http://www.hubeibidding.com/plus/list.php?tid=26"
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//ul[@class='e2']//li//a[@class='title']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    if '4' in item['_current_start_url']:
        ...
        item['bid_type'] = 0
    elif '26' in item['_current_start_url']:
        item['bid_type'] = 2
