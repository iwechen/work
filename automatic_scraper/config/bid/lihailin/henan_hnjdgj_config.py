...
author = "lihailin"
web_title = u"河南省机电设备国际中标有限公司"
data_source = 'http://www.hnjdgj.com'

start_urls = [
    #中标变更
   "http://www.hnjdgj.com/hnzbw/hwzb/zbgg.html",
    "http://www.hnjdgj.com/hnzbw/hwzb/zbgs.html",
    "http://www.hnjdgj.com/hnzbw/hwzb/bggg.html"
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='ArticleList']//tr//td[@class='fw_t']/parent::tr", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
