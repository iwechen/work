...
author = "lihailin"
web_title = u"甘肃经济信息网"
data_source = 'http://www.gsei.com.cn'

start_urls = [
    #招标
    "http://www.gsei.com.cn/html/1336/list-2.html",
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//ul[@class='label_ul_b']//a/parent::li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='main1']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
