...
author = "lihailin"
web_title = u"文水县政府采购中心"
data_source = 'http://www.wszfcg.cn'

start_urls = [
    "http://www.wszfcg.cn/class.asp?id=26",
    "http://www.wszfcg.cn/class.asp?id=28",
    "http://www.wszfcg.cn/class.asp?id=27"
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//ul[@id='listul']//li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    """
    # 停止翻页
    if '26' in item['_current_start_url']:
        item['bid_type'] = 1
    elif '28' in item['_current_start_url']:
        item['bid_type'] = 0
    elif '27' in item['_current_start_url']:
        item['bid_type'] = 2
    try:
