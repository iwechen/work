...
author = "lihailin"
web_title = u"中国招投标信息平台（吕梁）"
data_source = 'http://www.zgbidding.com.cn'

start_urls = [
    #招标公告
    "http://www.zgbidding.com.cn/news/search.php?kw=%E5%90%95%E6%A2%81",
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='catlist']//ul[@class='clearfix']//li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
