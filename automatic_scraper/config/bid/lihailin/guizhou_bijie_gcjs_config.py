...
author = "lihailin"
web_title = u"毕节市公共资源交易中心"
data_source = 'http://www.bjggzy.cn'

start_urls = [
    #建设工程
    "http://www.bjggzy.cn/gjsgc/index_1.jhtml",
    #政府采购
    "http://www.bjggzy.cn/gzfcg/index_1.jhtml"
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='List1 Top8']//li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
detail_pattern = {
    ...
    "sc": {'pattern': "//div[@class='Content BorderTopDot']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    """
    # 停止翻页
    if re.search(u'招标|谈判', item['title']):
        item['bid_type'] = 1
    elif re.search(u'结果', item['title']):
        item['bid_type'] = 0
    elif re.search(u'变更', item['title']):
        item['bid_type'] = 2
