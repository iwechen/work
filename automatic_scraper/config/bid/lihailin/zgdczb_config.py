...
author = "lihailin"
web_title = u"中国电力招标网"
data_source = 'http://www.zgdczb.com'

start_urls = [
    #设备招标.工程招标
    "http://www.zgdczb.com/news/shebeizb/",
    "http://www.zgdczb.com/news/gongcheng/"
]
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='left_box']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    # 停止翻页
    item['bid_type'] = 1
    if item['url'] == "http://www.zgdczb.com/news/":
        del item['url']
    try:
