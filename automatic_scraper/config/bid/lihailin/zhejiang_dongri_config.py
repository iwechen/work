...
author = "lihailin"
web_title = u"浙江东日股份有限公司"
data_source = 'http://www.dongri.com'

start_urls = [
    #招标公告
    "http://www.dongri.com/index.jsp?id0=z0gwsjjuz7&id1=z0ingskjf8",
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//table[@class='list']//tr", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
detail_pattern = {
    ...
    "sc": {'pattern': "//td[@id='note']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
