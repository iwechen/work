...
author = "lihailin"
web_title = u"山西华普工程招标代理有限公司"
data_source = 'http://www.hpbid.net'

start_urls = [
   "http://www.hpbid.net/list/?107_1.html",
   "http://www.hpbid.net/list/?116_1.html"
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//table[@class='border-b']//tr", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//table[@width='725']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    """
    # 停止翻页
    if '107' in item['_current_start_url']:
        item['bid_type'] = 1
    elif '116' in item['_current_start_url']:
        item['bid_type'] = 0
    try:
