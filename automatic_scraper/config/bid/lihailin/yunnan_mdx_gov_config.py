...
author = "lihailin"
web_title = u"牟定县人民政府"
data_source = 'http://www.mdx.gov.cn'

start_urls = [
    "http://www.mdx.gov.cn/index.php?m=content&c=index&a=lists&catid=50",
    "http://www.mdx.gov.cn/index.php?m=content&c=index&a=lists&catid=127"
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//td[@class='style4' and @align='left']//li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//td[@class='style4']//td[@align='left']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
