...
author = "lihailin"
web_title = u"山东日照东港政府"
data_source = 'http://www.rzdonggang.gov.cn'

start_urls = [
    "http://www.rzdonggang.gov.cn/rzdggov/xwzx12/ztzl/_2475/6985/index.html",
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//table[@class='xxgk_border']//tr", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='gov_infoCatalog_detailsection']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
