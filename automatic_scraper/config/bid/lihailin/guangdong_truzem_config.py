...
author = "lihailin"
web_title = u"广东筑正工程建设管理有限公司"
data_source = 'http://www.truzem.com'

start_urls = [
    #招标中标公告
    "http://www.truzem.com/zbgg/",
    "http://www.truzem.com/zbgs/"
]
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='nr']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
