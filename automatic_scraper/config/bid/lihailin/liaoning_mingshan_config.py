...
author = "lihailin"
web_title = u"明山区政府采购"
data_source = 'http://www.mingshan.gov.cn'

start_urls = [
    "http://www.mingshan.gov.cn/a/zhengwugongkai/zhengfucaigou/",
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='lb_neirong']//li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='wenzhangcontent']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
