...
author = "lihailin"
web_title = u"宁波市公共资源交易网余姚分网"
data_source = 'http://www.yyztb.gov.cn'

start_urls = [
    #招标公告
    "http://www.yyztb.gov.cn/BidNotice/jsgc/zbgg",
]
...
index_pattern = {
    ...
    "title": {'pattern': "//span[@class='f18']", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
    "_next_page": {'pattern': u"//a[contains(text(), '下页')]", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
}
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='details-content']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
