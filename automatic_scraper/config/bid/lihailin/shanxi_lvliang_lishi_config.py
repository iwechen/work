...
author = "lihailin"
web_title = u"吕梁市离石区人民政府"
data_source = 'http://www.lishi.gov.cn'

start_urls = [
    "http://www.lishi.gov.cn/index.php/cms/item-list-category-908.shtml",
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//ul[@class='label_ul_b']//li[position()<last()]", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='news_border']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
