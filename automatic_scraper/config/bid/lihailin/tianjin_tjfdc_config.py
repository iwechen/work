...
author = "lihailin"
web_title = u"天津市国土资源和房屋管理局"
data_source = 'http://www2.tjfdc.gov.cn'

start_urls = [
    #招标中标
    "http://www2.tjfdc.gov.cn/Pages/ezwgkmore.aspx?id=gt_zbcg",
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//table[@id='ctl00_ctl15_g_799b769c_db72_43d1_9fbd_555ec94d5506_GridViewWebPart']//tr", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@id='frameContent']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    if re.search(u'(中标)|(竞争性谈判公示)', item['title']):
        item['bid_type'] = '0'
    elif re.search(u'(招标)|(竞争性谈判公告)|(延期)|(采购)', item['title']):
        item['bid_type'] = '1'
