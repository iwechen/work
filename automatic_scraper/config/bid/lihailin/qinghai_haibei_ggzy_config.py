...
author = "lihailin"
web_title = u"海北州政府采购网站"
data_source = 'http://www.hbzwzx.gov.cn'

start_urls = [
    "http://www.hbzwzx.gov.cn/Front/showinfo/jyxxmore.aspx?CategoryNum=zbgg",
    "http://www.hbzwzx.gov.cn/Front/showinfo/jyxxmore.aspx?CategoryNum=zbgs"
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//tr[@valign='middle']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
