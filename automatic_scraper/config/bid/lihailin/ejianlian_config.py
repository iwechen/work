...
author = "lihailin"
web_title = u"亿建联"
data_source = 'http://www.ejianlian.com'

start_urls = [
    "http://www.ejianlian.com/Linkproject/bid/?search=1&p=1",
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='report']//li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "issue_time": {'pattern': "//span[@class='riqi f-fr']", 'type': 'xpath', 'target': 'text','custom_func_name': ''},
    "title": {'pattern': "//a", 'type': 'xpath', 'target': 'text','custom_func_name': ''},
    "_next_page": {'pattern': u"//a[contains(text(), '下一页')]", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
}
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='txtzb']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
