...
author = "lihailin"
web_title = u"广西钦州公共资源交易中心"
data_source = 'http://www.qzggzy.cn'
...
index_pattern = {
    ...
    "_next_page": {'pattern': "//img[@src='/gxqzzbw/images/page/nextn.gif']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
detail_pattern = {
    ...
    "sc": {'pattern': "//td[@bgcolor='#ffffff']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
