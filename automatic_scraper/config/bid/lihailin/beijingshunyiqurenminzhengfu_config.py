...
author = "lihailin"
web_title = u"北京顺义区人民政府"
data_source = 'http://www.bjshy.gov.cn'

start_urls = [
    #采购公告
    "http://www.bjshy.gov.cn/Category_744/Index_1.aspx",
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='gl_body_r']//li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
detail_pattern = {
    ...
    "sc": {'pattern': "//div[@class='nr_bg_02']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
