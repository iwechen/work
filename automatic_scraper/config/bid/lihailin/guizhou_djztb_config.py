...
author = "lihailin"
web_title = u"贵州德建招标代理有限公司"
data_source = 'http://www.djztb.com'

start_urls = [
    "http://www.djztb.com/news_category.asp?id=5",
]
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='center_body']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
