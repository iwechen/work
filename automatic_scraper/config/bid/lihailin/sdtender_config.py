...
author = "lihailin"
web_title = u"山东招标门户网"
data_source = 'http://www.sdtender.com'
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@id='list']//li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    """
    # 停止翻页
    if 'id=139' in item['_current_start_url']:
        item['bid_type'] = 1
    if 'id=140' in item['_current_start_url']:
        item['bid_type'] = 0
    try:
