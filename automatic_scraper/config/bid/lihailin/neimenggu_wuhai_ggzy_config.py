...
author = "lihailin"
web_title = u"乌海市公共资源交易中心"
data_source = 'http://www.whggzy.com'
...
index_pattern = {
    ...
    "_next_page": {'pattern': u"//a[@href and text()='后一页']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
detail_pattern = {
    ...
    "sc": {'pattern': "//div[@style='word-break : break-all']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
