...
author = "lihailin"
web_title = u"机电产品国际招标行政监管平台"
data_source = 'http://gov.chinabidding.com'

start_urls = [
    "http://gov.chinabidding.com/search/proj.htm"
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='as-pager']//li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "issue_time": {'pattern': "//span[@class='time']", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
    "title": {'pattern': "//span[@class='txt']", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
    "_next_page": {'pattern': u"//a[contains(text(), '下一页')]", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
}
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='as-article-body f_a_a_b']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
