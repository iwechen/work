...
author = "lihailin"
web_title = u"上杭县公共资源配置网"
data_source = 'http://www.shzyjy.cn'

start_urls = [
    "http://www.shzyjy.cn/news!list.action?page=1&code=3&title="
]
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='text f14']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
