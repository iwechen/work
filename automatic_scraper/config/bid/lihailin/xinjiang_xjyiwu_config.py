...
author = "lihailin"
web_title = u"新疆伊吾政府网"
data_source = 'http://www.xjyiwu.gov.cn'

start_urls = [
    "http://www.xjyiwu.gov.cn/open/zfxxgk/zfcg.htm",
]
...
index_pattern = {
    ...
    "issue_time": {'pattern': "//span[@class='timestyle51956']", 'type': 'xpath','target': 'text', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='c51920_content']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
