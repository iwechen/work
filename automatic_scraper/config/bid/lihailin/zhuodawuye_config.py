...
author = "lihailin"
web_title = u"卓达物业"
data_source = 'http://www.zhuodawuye.com'

start_urls = [
    "http://www.zhuodawuye.com/zdej.asp?dl=6&xl=175",
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='newslist padding30']//li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='padding30 shui25']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
