...
author = "lihailin"
web_title = u"大连市财政局"
data_source = 'http://www.czj.dl.gov.cn'

start_urls = [
    #招标公告
    "http://www.czj.dl.gov.cn/zfcg/zbtz.htm",
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//td//a[@class='c1065']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
