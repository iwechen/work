...
start_urls = [
    #招标公告
    "http://www.danzhou.gov.cn/dzgov/zwgk/zfcg/zbgg/",
    "http://www.danzhou.gov.cn/dzgov/zwgk/zfcg/zhbgg/"
]
...
detail_pattern = {
    ...
    "sc": {'pattern': "//div[@id='neirongText']|//td[@valign='top' and @align='center']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
