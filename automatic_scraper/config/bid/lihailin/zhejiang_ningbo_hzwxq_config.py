...
author = "lihailin"
web_title = u"宁波杭州湾新区"
data_source = 'http://www.hzwxq.com'

start_urls = [
    #招标中标变更
    "http://www.hzwxq.com/zw/wsbs/ggzyjyzx/gcjsxmzbgg/",
    "http://www.hzwxq.com/zw/wsbs/ggzyjyzx/gcjsxmzbgs/",
    "http://www.hzwxq.com/zw/wsbs/ggzyjyzx/zfcgzbgg/",
    "http://www.hzwxq.com/zw/wsbs/ggzyjyzx/zfcgzbgs/"
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='lbpage_r_inner']//li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
