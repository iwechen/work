...
author = "lihailin"
web_title = u"绍兴滨海新城"
data_source = 'http://www.sxbh.gov.cn'

start_urls = [
    #招标公告
    "http://www.sxbh.gov.cn/col/col12942/index.html",
    #中标
   "http://www.sxbh.gov.cn/col/col13009/index.html"
]
...
def process_list_item(list_element, item):
    ...
    """
    # 停止翻页
    if 'col12942' in item['_current_start_url']:
        item['bid_type'] = 1
    elif 'col13009' in item['_current_start_url']:
        item['bid_type'] = 0
    try:
