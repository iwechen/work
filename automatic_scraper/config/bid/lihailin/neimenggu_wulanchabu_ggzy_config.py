...
author = "lihailin"
web_title = u"乌兰察布市公共资源交易中心"
data_source = 'http://www.wlcbggzyjy.org.cn'
...
detail_pattern = {
    ...
    "sc": {'pattern': "//div[@class='article-content con']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    if '005001001' in item['_current_start_url'] or '005002001' in item['_current_start_url']:
        item['bid_type'] = 1
    elif '005001003' in item['_current_start_url'] or '005002004' in item['_current_start_url']:
        item['bid_type'] = 0
    elif '005001002' in item['_current_start_url']:
        item['bid_type'] = 2
