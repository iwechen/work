...
author = "lihailin"
web_title = u"山西广电信息网络集团"
data_source = 'http://www.isxtv.com'

start_urls = [
    "http://www.isxtv.com/list/?139_1.html",
    "http://www.isxtv.com/list/?149_1.html"
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//ul[@id='newlist']//li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='right_cen']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
