...
author = "lihailin"
web_title = u"罗平县公共资源交易网"
data_source = 'http://www.luoping.gov.cn'

start_urls = [
    "http://www.luoping.gov.cn/html/ggzyjyxxgg/index.html",
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//ul[@class='list lh24 f14']//li//a/parent::li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
