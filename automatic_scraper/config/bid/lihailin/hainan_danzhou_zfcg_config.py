...
author = "lihailin"
web_title = u"海南省儋州市政务网"
data_source = 'http://www.danzhou.gov.cn'

start_urls = [
    #招标
    "http://www.danzhou.gov.cn/dzgov/zwgk/zfcg/zbgg/index_1.html",
    # #中标
    "http://www.danzhou.gov.cn/dzgov/zwgk/zfcg/zhbgg/index.html",
]
...
detail_pattern = {
    ...
    "sc": {'pattern': ".", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    if res.headers['Content-Type']== 'application/msword':
        del item['url']
