...
index_pattern = {
    ...
    "title": {'pattern': "//a[@class='l' and @title]/@title", 'type': 'xpath', 'target': 'text','custom_func_name': ''},
    "_next_page": {'pattern': u"//a[contains(text(), '下一页')]", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
}
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='epoint-article-content']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
