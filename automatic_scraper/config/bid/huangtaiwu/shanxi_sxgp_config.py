...
author = "huangtaiwu"
web_title = u"山西省高平市政府门户网站"
data_source = 'http://www.sxgp.gov.cn'

start_urls = [

    "http://www.sxgp.gov.cn/html/zfcg/index.html",  # 1,0
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//li[@class='list-pt']", 'type': 'xpath', 'target': 'html','custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@id='contentsize']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
