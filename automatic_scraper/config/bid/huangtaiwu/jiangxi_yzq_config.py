...
author = "huangtaiwu"
web_title = u"袁州区政府网"
data_source = 'http://www.yzq.gov.cn'

start_urls = [
    "http://www.yzq.gov.cn/zwgk/czxx/zfcg/zbgg01/",  # 1
    "http://www.yzq.gov.cn/zwgk/czxx/zfcg/zbgs/",  # 0
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//td[@id='bk']/table[@width='97%']//tr[position()!=6 and position()!=12 and position()!=18 and position()!=24 and position()!=30]", 'type': 'xpath', 'target': 'html','custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    """
    # 停止翻页
    if re.search('zbgg01/', item['_current_start_url']):
        item['bid_type'] = 1
