...
author = "huangtaiwu"
web_title = u"广州市见智咨询有限公司"
data_source = 'http://www.gzsjz.cn'

start_urls = [

    "http://www.gzsjz.cn/zhaobiaogonggao/",  # 1
    "http://www.gzsjz.cn/zhongbiaogonggao/",# 0
...
index_pattern = {
    ...
    "title": {'pattern': "//a", 'type': 'xpath', 'target': 'text',
              'custom_func_name': ''},
