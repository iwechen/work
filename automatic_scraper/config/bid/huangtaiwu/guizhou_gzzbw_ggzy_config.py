...
author = "huangtaiwu"
web_title = u"贵州省招标投标公共服务平台"
data_source = 'http://www.gzzbw.cn'

start_urls = [
    "http://www.gzzbw.cn/zbgg/index.jhtml",  # 1
    "http://www.gzzbw.cn/zbgs/index.jhtml", # 0
    "http://www.gzzbw.cn/searchCustom.jspx?tpl=zbbg", # 2
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//table[@class='table textcenter']/tbody/tr", 'type': 'xpath', 'target': 'html',
              'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='content-txt']", 'type': 'xpath', 'target': 'clean_html',
           'custom_func_name': ''},
    "issue_time": {'pattern': "//div[@class='content-inf']", 'type': 'xpath', 'target': 'text',
                   'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    if re.search('zbgg', item['_current_start_url']):
        ...
        item['bid_type'] = 0
    elif re.search('zbbg', item['_current_start_url']):
        item['bid_type'] = 2
    else:
        item['bid_type'] = -1
