...
author = "huangtaiwu"
web_title = u"沧州市人民政府"
data_source = 'http://www.cangzhou.gov.cn'

start_urls = [
    "http://www.cangzhou.gov.cn/HBSC/Services/cangzhougovcn/zwzx/ggzyjy_list.jsp?key=018002001",  # 1
    "http://www.cangzhou.gov.cn/HBSC/Services/cangzhougovcn/zwzx/ggzyjy_list.jsp?key=018002005",  # 0
    "http://www.cangzhou.gov.cn/HBSC/Services/cangzhougovcn/zwzx/ggzyjy_list.jsp?key=018001001",  # 1
    "http://www.cangzhou.gov.cn/HBSC/Services/cangzhougovcn/zwzx/ggzyjy_list.jsp?key=018001004",  # 0
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='liot_t_c']//li", 'type': 'xpath', 'target': 'html',
              'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    """
    # 停止翻页
    if re.search('018002001|018001001', item['_current_start_url']):
        item['bid_type'] = 1
    elif re.search('018002005|018001004', item['_current_start_url']):
        item['bid_type'] = 0
    else:
        item['bid_type'] = -1
