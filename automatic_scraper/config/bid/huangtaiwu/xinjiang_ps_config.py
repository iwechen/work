...
author = "huangtaiwu"
web_title = u"皮山县政府门户网站"
data_source = 'http://www.ps.gov.cn'

start_urls = [
    "http://www.ps.gov.cn/55/list_1.htm",  # 1,0
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//tr[@class='TrCss']", 'type': 'xpath', 'target': 'html',
              'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//td[@valign='top']/p/parent::td", 'type': 'xpath', 'target': 'clean_html',
           'custom_func_name': ''},
