...
author = "huangtaiwu"
web_title = u"高安市人民政府"
data_source = 'http://www.gaoan.gov.cn'

start_urls = [
    "http://www.gaoan.gov.cn/zwgk_49126/zfcg/zbgg/",  # 1
    "http://www.gaoan.gov.cn/zwgk_49126/zfcg/cgzbgg/", # 0
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='pian222']", 'type': 'xpath', 'target': 'html','custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='artibody']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    if re.search('zbgg/', item['_current_start_url']):
        item['bid_type'] = 1
    elif re.search('cgzbgg/', item['_current_start_url']):
        item['bid_type'] = 0
    else:
        item['bid_type'] = -1
