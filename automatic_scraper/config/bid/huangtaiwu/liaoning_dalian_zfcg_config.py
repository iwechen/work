...
author = "huangtaiwu"
web_title = u"大连市政府采购网"
data_source = 'http://www.ccgp.dl.gov.cn'

start_urls = [
    "http://www.ccgp.dl.gov.cn/dlweb/023/023001/MoreInfo.aspx?CategoryNum=023001",  # 1
    "http://www.ccgp.dl.gov.cn/dlweb/023/023002/MoreInfo.aspx?CategoryNum=023002",  # 0
]
...
index_pattern = {
    ...
    "_next_page": {'pattern': "//a[@href]/img[@src='/dlweb/images/page/nextn.gif']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//table[@id='Table4']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    """
    # 停止翻页
    if re.search('023001', item['_current_start_url']):
        item['bid_type'] = 1
    elif re.search('023002', item['_current_start_url']):
        item['bid_type'] = 0
    else:
        item['bid_type'] = -1
