...
author = "huangtaiwu"
web_title = u"北京市大兴区人民政府网站"
data_source = ''

start_urls = [
    "http://www.bjdx.gov.cn/zwgk/zfgz/zfcg/zhbxx/index.html",#1
    "http://www.bjdx.gov.cn/zwgk/zfgz/zfcg/zbxx/index.html",#0
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//ul[@class='article_list clearfix']/li", 'type': 'xpath', 'target': 'html','custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='common_content_detail']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    """
    # 停止翻页
    if re.search('zhbxx', item['_current_start_url']):
        item['bid_type'] = 1
    elif re.search('zbxx', item['_current_start_url']):
        item['bid_type'] = 0
    else:
        item['bid_type'] = -1
