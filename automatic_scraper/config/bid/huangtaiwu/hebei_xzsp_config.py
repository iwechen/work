...
author = "huangtaiwu"
web_title = u"沧州市政务服务中心"
data_source = 'http://xzsp.cangzhou.gov.cn'

start_urls = [

    "http://xzsp.cangzhou.gov.cn/HBSC/Services/zwfwzx/a_list.jsp?key=018001001",  # 1
    "http://xzsp.cangzhou.gov.cn/HBSC/Services/zwfwzx/a_list.jsp?key=018001004",  # 0
    "http://xzsp.cangzhou.gov.cn/HBSC/Services/zwfwzx/a_list.jsp?key=018002001",  # 1
    "http://xzsp.cangzhou.gov.cn/HBSC/Services/zwfwzx/a_list.jsp?key=018002005",  # 0
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//ul[@class='ul_list']/li", 'type': 'xpath', 'target': 'html',
              'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    """
    # 停止翻页
    if re.search('018001001|018002001', item['_current_start_url']):
        item['bid_type'] = 1
    elif re.search('018001004|018002005', item['_current_start_url']):
        item['bid_type'] = 0
    else:
        item['bid_type'] = -1
