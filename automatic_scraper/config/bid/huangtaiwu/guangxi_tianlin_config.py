...
author = "huangtaiwu"
web_title = u"田林县人民政府网"
data_source = 'http://www.tianlin.gov.cn'

start_urls = [

    "http://www.tianlin.gov.cn/index.php?m=content&c=index&a=lists&catid=55",   # 1，0
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='lismain']/ul/li[not(@class)]", 'type': 'xpath', 'target': 'html','custom_func_name': ''},
