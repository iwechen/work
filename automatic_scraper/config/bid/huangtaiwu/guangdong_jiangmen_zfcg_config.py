...
data_source = 'http://jiangmen.gdgpo.gov.cn'

start_urls = [
    "http://jiangmen.gdgpo.gov.cn/queryMoreInfoList/channelCode/0005.html",#1
    "http://jiangmen.gdgpo.gov.cn/queryMoreInfoList/channelCode/0006.html", # 2
    "http://jiangmen.gdgpo.gov.cn/queryMoreInfoList/channelCode/0006.html",#0
]
