...
author = "huangtaiwu"
web_title = u"河南省国贸招标有限公司"
data_source = 'http://www.hngmzb.com'

start_urls = [
    "http://www.hngmzb.com/zhaobiaogonggao/",  # 1
    "http://www.hngmzb.com/zhaobiaokuaibao/",  # 0
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='listp']/ul/li", 'type': 'xpath', 'target': 'html',
              'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='content_nei']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    if re.search('zhaobiaogonggao', item['_current_start_url']):
        item['bid_type'] = 1
    elif re.search('zhaobiaokuaibao', item['_current_start_url']):
        item['bid_type'] = 0
    else:
        item['bid_type'] = -1
