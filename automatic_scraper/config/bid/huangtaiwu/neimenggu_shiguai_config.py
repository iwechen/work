...
author = "huangtaiwu"
web_title = u"包头市石拐区政府门户网"
data_source = 'http://www.shiguai.gov.cn'

start_urls = [
    "http://www.shiguai.gov.cn/active/fpage_1.jsp?psize=20&showpagenum=true&fid=9237&titlelen=37&titleicon=/images/stitle_exp/system_201297154830.gif",# 1,0
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//table[@class='recordlist']//tr[not(@class)]", 'type': 'xpath', 'target': 'html','custom_func_name': ''},
