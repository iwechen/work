...
author = "huangtaiwu"
web_title = u"和顺县人民政府"
data_source = 'http://www.heshun.gov.cn'

start_urls = [
    "http://www.heshun.gov.cn/xinxigongkai/xinxigongkaimulu/caigouzhaobiao/",  # 1,0
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='list_main_c_right']//li", 'type': 'xpath', 'target': 'html','custom_func_name': ''},
