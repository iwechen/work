...
author = "huangtaiwu"
web_title = u"平顶山市公共资源交易中心"
data_source = 'http://www.pdsggzy.com'

start_urls = [
    "http://www.pdsggzy.com/gzbgg/index.jhtml",  # 1
    "http://www.pdsggzy.com/gbcgg/index.jhtml",  # 2
    "http://www.pdsggzy.com/gcqdy/index.jhtml",  # 2
    "http://www.pdsggzy.com/gzbgs/index.jhtml",  # 0
    "http://www.pdsggzy.com/zzbgg/index.jhtml",  # 1
    "http://www.pdsggzy.com/zbcgg/index.jhtml",  # 2
    "http://www.pdsggzy.com/zcqdy/index.jhtml",  # 2
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='infolist-main']/ul/li", 'type': 'xpath', 'target': 'html',
              'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    """
    # 停止翻页
    if re.search('gzbgg|zzbgg', item['_current_start_url']):
        item['bid_type'] = 1
    elif re.search('gzbgs|zzbgs', item['_current_start_url']):
        item['bid_type'] = 0
    elif re.search('gbcgg|gcqdy|zbcgg|zcqdy', item['_current_start_url']):
        item['bid_type'] = 2
    else:
        item['bid_type'] = -1
