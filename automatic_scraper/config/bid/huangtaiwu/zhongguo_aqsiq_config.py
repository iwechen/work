...
author = "huangtaiwu"
web_title = u"国家质量监督检验检疫总局"
data_source = 'http://www.aqsiq.gov.cn'

start_urls = [
    "http://www.aqsiq.gov.cn/xxgk_13386/zfcg/zbxxfb/xxgkml_1_4443.htm",#1
    "http://www.aqsiq.gov.cn/xxgk_13386/zfcg/zbjggg/xxgkml_1_4443.htm",#0
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//td[@class='border2']//tr", 'type': 'xpath', 'target': 'html','custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//td[@class='border']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    """
    # 停止翻页
    if re.search('zbxxfb', item['_current_start_url']):
        item['bid_type'] = 1
