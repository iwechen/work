...
author = "huangtaiwu"
web_title = u"怀来县公共资源交易中心"
data_source = 'http://www.hlggzy.com'

start_urls = [

    "http://www.hlggzy.com/Class.asp?ID=25",  # 1
    "http://www.hlggzy.com/Class.asp?ID=26",# 0,4
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//ul[@id='listul']/li", 'type': 'xpath', 'target': 'html',
              'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    """
    # 停止翻页
    if re.search('ID=25', item['_current_start_url']):
        item['bid_type'] = 1
    elif re.search('ID=26', item['_current_start_url']):
        item['bid_type'] = 0
    else:
        item['bid_type'] = -1
