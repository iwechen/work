...
author = "huangtaiwu"
web_title = u"资产管理处"
data_source = 'http://gyzczx.czmc.com'

start_urls = [
    "http://gyzczx.czmc.com/zbxx.htm",  # 1,0
]
...
index_pattern = {
    ...
    "_next_page": {'pattern': u"//a[@href and contains(text(),'下页')]", 'type': 'xpath', 'target': 'html',
                   'custom_func_name': ''},
    "title": {'pattern': "//a", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
    "issue_time": {'pattern': "//span[@class='timestyle40141']", 'type': 'xpath', 'target': 'text',
                   'custom_func_name': ''},

}
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@id='vsb_content']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
