...
author = "huangtaiwu"
web_title = u"渤海新区公共资源交易中心"
data_source = 'http://bhxqzwzx.cangzhou.gov.cn'

start_urls = [

    "http://bhxqzwzx.cangzhou.gov.cn/ggzyjy/jysx/gcjs/qbgg/index.shtml",  # 1
    "http://bhxqzwzx.cangzhou.gov.cn/ggzyjy/jysx/gcjs/zbgq/index.shtml",  # 0
    "http://bhxqzwzx.cangzhou.gov.cn/ggzyjy/jysx/zfcg/cggg/index.shtml",  # 1
    "http://bhxqzwzx.cangzhou.gov.cn/ggzyjy/jysx/zfcg/bggg/index.shtml",  # 2
    "http://bhxqzwzx.cangzhou.gov.cn/ggzyjy/jysx/zfcg/zbgq/index.shtml",  # 0
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//ul[@class='list_ul']/li", 'type': 'xpath', 'target': 'html',
              'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    if re.search('qbgg|cggg', item['_current_start_url']):
        item['bid_type'] = 1
    elif re.search('zbgq|zbgq', item['_current_start_url']):
        item['bid_type'] = 0
