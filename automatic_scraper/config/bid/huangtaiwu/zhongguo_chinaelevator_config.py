...
author = "huangtaiwu"
web_title = u"中国电梯网"
data_source = 'http://www.chinaelevator.net'

start_urls = [
    "http://www.chinaelevator.net/news/?list_31.html",  # 1 0
    "http://www.chinaelevator.net/news/?list_32.html",  # 1 0
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//dd[@class='listBox1']//li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "_next_page": {'pattern': "//div[@class='navBtn fontNav2_2']//following-sibling::a[1]", 'type': 'xpath',
                   'target': 'html', 'custom_func_name': ''},
    "title": {'pattern': "//a[@class='font1_1']", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
    "issue_time": {'pattern': "//div[@class='addi']", 'type': 'xpath', 'target': 'text',
                   'custom_func_name': ''},
