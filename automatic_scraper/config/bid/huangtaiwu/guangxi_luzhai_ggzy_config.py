...
author = "huangtaiwu"
web_title = u"中国鹿寨政府网"
data_source = 'http://zwfwzx.luzhai.gov.cn'

start_urls = [
    "http://zwfwzx.luzhai.gov.cn/ggzyjy1/zbgg/index.shtml",#1
    "http://zwfwzx.luzhai.gov.cn/ggzyjy1/zbgg1/index.shtml",#0
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='RightSide_con']//li", 'type': 'xpath', 'target': 'html','custom_func_name': ''},
...
detail_pattern = {
    ...
    "title": {'pattern': "//div[@class='mainCont']/h1", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
