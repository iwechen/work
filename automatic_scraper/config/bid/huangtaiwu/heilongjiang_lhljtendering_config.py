...
author = "huangtaiwu"
web_title = u"黑龙江省招标公司"
data_source = 'http://www.hljtendering.com.cn'

start_urls = [
    "http://www.hljtendering.com.cn/view/zbgg/index_1.html",  # 1
    "http://www.hljtendering.com.cn/view/zbjg/index_1.html",  # 0
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//table[@class='azbgg']//tr[position()>1 and position()<last()]", 'type': 'xpath', 'target': 'html',
              'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//table[@class='azbgg']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    if re.search('zbgg', item['_current_start_url']):
        item['bid_type'] = 1
    elif re.search('zbjg', item['_current_start_url']):
        item['bid_type'] = 0
    else:
        item['bid_type'] = -1
