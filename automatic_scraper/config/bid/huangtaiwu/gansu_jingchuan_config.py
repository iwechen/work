...
author = "huangtaiwu"
web_title = u"泾川县门户网"
data_source = 'http://www.jingchuan.gov.cn'

start_urls = [
    "http://www.jingchuan.gov.cn/index.php?m=content&c=index&a=lists&catid=106",#1,0
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='list']//ul/li[not(@class)]", 'type': 'xpath', 'target': 'html','custom_func_name': ''},
...
detail_pattern = {
    ...
    "title": {'pattern': "//div[@class='hd']/h1", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
