...
author = "huangtaiwu"
web_title = u"沧州市交通运输局"
data_source = 'http://www.hebczjt.gov.cn'

start_urls = [

    "http://www.hebczjt.gov.cn/zwzc/ztb/index.shtml",  # 1,0
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='zw_xxlb']/ul/li", 'type': 'xpath', 'target': 'html',
              'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@id='content']|//div[@class='Content']|//table[@width='930' and @cellspacing='0']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
