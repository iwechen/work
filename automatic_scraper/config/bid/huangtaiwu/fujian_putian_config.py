...
author = "huangtaiwu"
web_title = u"莆田市建设信息网"
data_source = 'http://wcm.putian.gov.cn'

start_urls = [

    "http://wcm.putian.gov.cn/pub/ptjs/ztbgg/",  # 1,0
...
index_pattern = {
    ...
    "_list": {'pattern': "//ul[@class='list1 pad_T15 doclist']//li", 'type': 'xpath', 'target': 'html',
              'custom_func_name': ''},
    "_next_page": {'pattern': u"//a[@onclick and contains(text(),'下一页')]", 'type': 'xpath', 'target': 'html',
                   'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@id='detailContent']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
