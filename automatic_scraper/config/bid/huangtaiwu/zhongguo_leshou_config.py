...
author = "huangtaiwu"
web_title = u"乐收推广"
data_source = 'http://site.leshou.com'

start_urls = [
    "http://site.leshou.com/section/136/page1",  # 1,0
]
...
index_pattern = {
    ...
    "_list": {'pattern': "//div[@class='each-entry']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "_next_page": {'pattern': u"//div[@class='pages']/span[@class='current']//following-sibling::a[1]", 'type': 'xpath', 'target': 'html',
                   'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='detail-body']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
