...
author = "huangtaiwu"
web_title = u"山东朝阳招标有限公司"
data_source = 'http://www.sdzyang.com'

start_urls = [
    "http://www.sdzyang.com/subweb/zbgg.asp",  # 1
    "http://www.sdzyang.com/subweb/zbjg.asp",  # 0
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//table[@width='98%']/tbody/tr[position()>2 and position()<last()]", 'type': 'xpath', 'target': 'html',
              'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//td[@bgcolor='#F3F3F3' and @valign='top']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
