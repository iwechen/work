...
author = "huangtaiwu"
web_title = u"植物网"
data_source = 'http://www.zhiwuwang.com'

start_urls = [
    "http://www.zhiwuwang.com/news/list-1194.html",  # 1,0
    "http://www.zhiwuwang.com/news/list-1195.html",
    "http://www.zhiwuwang.com/news/list-1196.html",
    "http://www.zhiwuwang.com/news/list-1197.html",
]
...
index_pattern = {
    ...
    "_next_page": {'pattern': u"//a[@href and contains(text(),'下一页')]", 'type': 'xpath', 'target': 'html',
                   'custom_func_name': ''},
    "title": {'pattern': "//a", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
    "issue_time": {'pattern': "//span", 'type': 'xpath', 'target': 'text',
                   'custom_func_name': ''},
    "_page_count": {'pattern': "/html//div[@class='pages']//cite", 'type': 'xpath', 'target': 'text',
                    'custom_func_name': ''},

}
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@id='article']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    item['_page_count'] = re.search(u'.*?/(\d+)', item['_page_count']).group(1)
