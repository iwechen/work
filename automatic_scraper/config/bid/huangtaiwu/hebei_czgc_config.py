...
author = "huangtaiwu"
web_title = u"沧州市建设工程信息网"
data_source = 'http://www.czgc.net'

start_urls = [
    "http://www.czgc.net/zbgg/index.htm",  # 1
    "http://www.czgc.net/zbgs/index.htm",  # 0
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='gngjList']//li", 'type': 'xpath', 'target': 'html',
              'custom_func_name': ''},
    "_next_page": {'pattern': u"//a[@onclick and contains(text(),'下一页')]", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
