...
author = "huangtaiwu"
web_title = u"中国地质调查局"
data_source = 'http://www.cgs.gov.cn'

start_urls = [
    "http://www.cgs.gov.cn/tzgg/zfcg_5637/zbxx_5638/",#1
    "http://www.cgs.gov.cn/tzgg/zfcg_5637/zbxx_5639/",#0
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='c_t_21']/ul[@id='feizhiding']/li", 'type': 'xpath', 'target': 'html','custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='c_body']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    """
    # 停止翻页
    if re.search('zbxx_5638', item['_current_start_url']):
        item['bid_type'] = 1
    elif re.search('zbxx_5639', item['_current_start_url']):
        item['bid_type'] = 0
    else:
        item['bid_type'] = -1
