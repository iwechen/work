...
author = "huangtaiwu"
web_title = u"中国·金乡县委县政府门户网站"
data_source = 'http://www.jinxiang.gov.cn'

start_urls = [
    "http://www.jinxiang.gov.cn/col/col455/index.html",  # 1
    "http://www.jinxiang.gov.cn/col/col456/index.html",  # 0
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='default_pgContainer']//tr", 'type': 'xpath', 'target': 'html',
              'custom_func_name': ''},
    "_next_page": {'pattern': u"//div[@class='default_pgBtn default_pgNext' and @title='下页']", 'type': 'xpath',
...
def process_list_item(list_element, item):
    ...
    """
    # 停止翻页
    if re.search('col455', item['_current_start_url']):
        item['bid_type'] = 1
    elif re.search('col456', item['_current_start_url']):
        item['bid_type'] = 0
    else:
        item['bid_type'] = -1
