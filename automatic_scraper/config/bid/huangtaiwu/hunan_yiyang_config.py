...
author = "huangtaiwu"
web_title = u"益阳公共资源交易中心"
data_source = 'http://jyzx.yiyang.gov.cn'

start_urls = [
    "http://jyzx.yiyang.gov.cn/jyxx/003001/jyxx.html",#1,0
    "http://jyzx.yiyang.gov.cn/jyxx/003002/jyxx.html",#1,0
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//ul[@class='ewb-r-items']/li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='news-article']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
