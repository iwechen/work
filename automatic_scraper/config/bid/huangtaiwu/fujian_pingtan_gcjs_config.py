...
author = "huangtaiwu"
web_title = u"工程招投标信息_中国平潭"
data_source = 'http://www.ptshsyj.gov.cn'

start_urls = [
    "http://www.ptshsyj.gov.cn/jhtml/cn/2952",#1
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='info_list list']//li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    """
    # 停止翻页
    if re.search('2952',item['_current_start_url']):
        item['bid_type'] = 1
    else:
        item['bid_type'] = -1
