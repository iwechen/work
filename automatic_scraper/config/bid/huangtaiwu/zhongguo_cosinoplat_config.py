...
author = "huangtaiwu"
web_title = u"中国远洋海外建设物资供应平台"
data_source = 'http://www.cosinoplat.com'

start_urls = [
    "http://www.cosinoplat.com/news.php?cid=4",# 1
...
index_pattern = {
    ...
    "_next_page": {'pattern': u"//a[@href and @title='下一页']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@id='textarea']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
