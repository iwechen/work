...
author = "huangtaiwu"
web_title = u"株洲县政府"
data_source = 'http://www.zzx.gov.cn'

start_urls = [

    "http://www.zzx.gov.cn//c420/index.html", # 1,0
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//ul[@class='column_list']/li", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='art_main']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''},
...
def process_list_item(list_element, item):
    ...
    if re.search(u'更正公告|更正|更改', item['title']):
        item['bid_type'] = 2
    if re.search(u'资格|预审', item['title']):
        item['bid_type'] = 7
