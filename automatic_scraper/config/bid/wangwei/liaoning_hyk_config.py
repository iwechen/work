...
author = "WangWei"
web_title = u"大连花园口经济区"
data_source = 'http://www.hyk.gov.cn'

start_urls = [
    "http://www.hyk.gov.cn/a/zhengwugongkai/zhengfucaigou/caigouzhaobiao/list_346_1.html?COLLCC=678257106&"
]
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='viewbox']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''}
}
