...
author = "WangWei"
web_title = u"河南医药招标采购网"
data_source = 'http://hnyyzb.com.cn'

start_urls = [
    "http://hnyyzb.com.cn/mengshixinxi/hebi/"
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//ul[@id='publishlist0']//li", 'type': 'xpath', 'target': 'html','custom_func_name': ''},
    "_next_page": {'pattern': u"//a[@href and text()='下一页']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "title": {'pattern': "//a", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
    "issue_time": {'pattern': "//span[last()]", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''}

}
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='infobox boxbg3']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''}
}
