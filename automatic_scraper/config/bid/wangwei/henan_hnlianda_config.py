...
author = "WangWei"
web_title = u"河南联达工程管理与限公司"
data_source = 'http://www.hnlianda.net'

start_urls = [
    "http://www.hnlianda.net/news.aspx?type=6",
    "http://www.hnlianda.net/news.aspx?type=7"
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@id='ctl00_ContentPlaceHolder1_Panel1']//table[@width='100%']//tr", 'type': 'xpath', 'target': 'html','custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//table[@class='mar_top']//table[@width='99%']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''}
}
