...
author = "WangWei"
web_title = u"中国住建网"
data_source = 'http://www.zhujianpt.com'

start_urls = [
    "http://www.zhujianpt.com/notice/zbyg.html",
    "http://www.zhujianpt.com/notice.html",
    "http://www.zhujianpt.com/notice/zbbg.html",
    "http://www.zhujianpt.com/notice/yqzb.html",
    "http://www.zhujianpt.com/result.html"
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@id='searchcontent']//li", 'type': 'xpath', 'target': 'html','custom_func_name': ''},
    ...
    "issue_time": {'pattern': "//div[@class='s_c_l_pub_date left']", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
    "region": {'pattern': "//div[@class='s_c_l_province left']", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''}

}
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='contentLL']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''}
}
...
def process_list_item(list_element, item):
    ...
    item['region']=item['region'].strip().replace('[','').replace(']','')
