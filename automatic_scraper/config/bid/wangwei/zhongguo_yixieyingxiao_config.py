...
author = "WangWei"
web_title = u"医械营销网"
data_source = 'http://www.yixieyingxiao.com'

start_urls = [
    "http://www.yixieyingxiao.com/JxsHPublish/Index.html"
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//table[@class='zbjg_table']//tr[not(th)]", 'type': 'xpath', 'target': 'html','custom_func_name': ''},
    "_next_page": {'pattern': u"//a[@href and text()='下一页 >']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "title": {'pattern': "//td[@class='cgdt_title']//a", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
    "issue_time": {'pattern': "//td[@class='cgdt_time']", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''}

}
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='zbdt_left fl']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''}
}
