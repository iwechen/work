...
author = "WangWei"
web_title = u"叶城县人民政府"
data_source = 'http://www.xjyc.gov.cn'

start_urls = [
    "http://www.xjyc.gov.cn/html/cg/Index.html",
    "http://www.xjyc.gov.cn/html/zbgs/Index.html",
    "http://www.xjyc.gov.cn/html/zb/Index.html",
    "http://www.xjyc.gov.cn/html/fscg/Index.html",
    "http://www.xjyc.gov.cn/html/bg/Index.html"
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//table//tr[not(@class)]", 'type': 'xpath', 'target': 'html','custom_func_name': ''},
    "_next_page": {'pattern': u"//a[@href and text()='下页']", 'type': 'xpath', 'target': 'html', 'custom_func_name': ''},
    "title": {'pattern': "//div[@class='xx_tit1']//a[@title]", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''},
    "issue_time": {'pattern': "//td[last()]", 'type': 'xpath', 'target': 'text', 'custom_func_name': ''}

}
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='main_list fr']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''}
}
