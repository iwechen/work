...
author = "WangWei"
web_title = u"大连市中山人民政府"
data_source = 'http://www.dlzs.gov.cn'

start_urls = [
    "http://www.dlzs.gov.cn/xxgk/cgzb/zsbx.htm",
    "http://www.dlzs.gov.cn/xxgk/cgzb/zbgg.htm",
    "http://www.dlzs.gov.cn/xxgk/cgzb/zxcggs.htm"
]
...
# 列表页模板
index_pattern = {
    "_list": {'pattern': "//div[@class='con-list-right']//li", 'type': 'xpath', 'target': 'html','custom_func_name': ''},
...
# 详情页模板
detail_pattern = {
    "sc": {'pattern': "//div[@class='content-list']", 'type': 'xpath', 'target': 'clean_html', 'custom_func_name': ''}
}
...
def process_list_item(list_element, item):
    ...
    item['issue_time'] = int(time.mktime(time.strptime(str(item['issue_time']), u"%Y-%m-%d %M:%S")))
